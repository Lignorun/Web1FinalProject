...
$level = 2; // Set the level to 2 for this page
$lives = 6; // Starting lives (or get this from session)

// Get the current level from session (if applicable)
if (isset($_SESSION['level'])) {
    $level = $_SESSION['level']; // Set the level from session
} else {
    $_SESSION['level'] = 2; // Default to level 2
}
